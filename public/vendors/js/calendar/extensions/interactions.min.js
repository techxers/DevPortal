    ...
    var y = function (e) {
        ...
        function n(n) {
            ...
            r.dragSelection = null, r.handlePointerDown = function (e) {
                ...
                var o = r.component.calendar, a = null, l = !1;
                e && ((a = function (e, n, r) {
    ...
    var w = function (e) {
        function n(r) {
            ...
            o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingCalendar = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
                var n = e.origEvent.target, r = o, i = r.component, a = r.dragging, l = a.mirror, s = i.calendar,
                    c = o.subjectSeg = t.getElSeg(e.subjectEl), d = (o.eventRange = c.eventRange).instance.instanceId;
                ...
                var n = o.component.calendar, r = o.eventRange, i = r.instance.instanceId;
                e.isTouch ? i !== o.component.props.eventSelection && n.dispatch({
                    type: "SELECT_EVENT",
                    eventInstanceId: i
                }) : n.dispatch({type: "UNSELECT_EVENT"}), o.isDragging && (n.unselect(e), n.publiclyTrigger("eventDragStart", [{
                    el: o.subjectSeg.el,
                ...
                if (o.isDragging) {
                    var r = o.relevantEvents, i = o.hitDragging.initialHit, a = o.component.calendar, l = null,
                        s = null, c = null, d = !1, g = {
                            affectedEvents: r,
                ...
                if (o.isDragging) {
                    var n = o.component.calendar, r = o.component.view, a = o, l = a.receivingCalendar,
                        s = a.validMutation, c = o.eventRange.def, d = o.eventRange.instance,
                        g = new t.EventApi(n, c, d), u = o.relevantEvents, h = o.mutatedRelevantEvents,
                    ...
                    if (o.clearDrag(), n.publiclyTrigger("eventDragStop", [{
                        ...
                        if (l === n) {
                            ...
                            }), e.isTouch && l.dispatch({type: "SELECT_EVENT", eventInstanceId: d.instanceId});
            ...
            var a = o.component, l = o.dragging = new f(a.el);
    ...
    var T = function (e) {
        function n(n) {
            ...
            r.draggingSeg = null, r.eventRange = null, r.relevantEvents = null, r.validMutation = null, r.mutatedRelevantEvents = null, r.handlePointerDown = function (e) {
                ...
                var a = r.component.calendar, l = r.relevantEvents, s = r.hitDragging.initialHit,
    ...
    var M = function () {
        ...
        function e(e, n) {
            ...
            this.receivingCalendar = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
                ...
                if (r.clearDrag(), o && a) {
                    var l = r.hitDragging.finalHit, s = l.component.view, c = r.dragMeta,
