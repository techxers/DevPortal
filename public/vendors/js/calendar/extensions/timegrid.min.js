...
!function (e, t) {
    ...
    var o = function () {
        ...
        return n(r, e), r.prototype.attachSegs = function (e, t) {
            ...
            var i, n, o, s = this.context.view, a = e.eventRange, l = a.def, d = a.ui, c = l.allDay,
                h = s.computeEventDraggable(l, d), u = e.isStart && s.computeEventStartResizable(l, d),
                p = e.isEnd && s.computeEventEndResizable(l, d), f = this.getSegClasses(e, h, u || p, r),
                g = t.cssToStr(this.getSkinCss(d));
            if (f.unshift("fc-time-grid-event"), t.isMultiDayRange(a.range)) {
                if (e.isStart || e.isEnd) {
                    var m = e.start, y = e.end;
    ...
    var c = function (e) {
        ...
        function i(r, i, n) {
            ...
            var a = o.eventRenderer = new s(o), l = o.fillRenderer = new h(o);
        ...
        return n(i, e), i.prototype.processOptions = function () {
            ...
            var n = this.theme, o = this.dateEnv, s = this.view, a = new r.DayBgRow(this.context);
            ...
            var i = this.dateEnv, n = this.snapsPerSlot, o = this.slatPositions, s = this.colPositions,
    ...
    var y = function (e) {
        function r(r, i) {
            ...
            return n.buildDayRanges = t.memoize(v), n.slicer = new S, n.timeGrid = i, r.calendar.registerInteractiveComponent(n, {el: n.timeGrid.el}), n
        }
