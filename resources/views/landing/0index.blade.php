...
@section('content')
    ...
    <div class="owl-carousel owl-1" id="home-section">
        <div class="site-blocks-cover overlay"
             style="background-image: url({{asset("img/heroslide1.png")}});"
             data-aos="fade">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <p class="mb-0"><a href="{{route('register')}}" class="smoothscroll btn btn-primary px-4 py-2 rounded-0">Register Now</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="site-blocks-cover overlay"
             style="background-image: url({{asset("img/heroslide2.png")}});z-index: 44"
             data-aos="fade"
             id="home-section">
            <div class="container">
                <div class="row align-items-center justify-content-center">
        ...
        <div class="site-blocks-cover overlay"
             style="background-image: url({{asset("img/heroslide3.png")}});z-index: 44"
             data-aos="fade"
             id="home-section">
            <div class="container">
                <div class="row align-items-center justify-content-center">
        ...
        <div class="container">
            <div class="row mb-1">
                <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="">
                    <img src="{{asset('img/tracking.svg')}}" alt="Free Website Template by Free-Template.co"
            ...
            <div class="row">
                <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
                    <figure class="circle-bg mt-2">
                        <img src="{{asset('img/company_env.png')}}" alt="NeutronIT Logo" class="img-fluid">
                    </figure>
                </div>
            ...
            <div class="row align-items-lg-center">
                <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
                    ...
                    <div class="owl-carousel slide-one-item-alt">
                        <img src="{{asset('img/slide_1.png')}}" alt="Image" class="img-fluid">
                        <img src="{{asset('img/slide_2.png')}}" alt="Image" class="img-fluid">
                        <img src="{{asset('img/slide_3.png')}}" alt="Image" class="img-fluid">
                    </div>
            ...
            <div class="row mb-5 justify-content-center">
                @foreach(\App\Service::all() as $service)
                    <div class="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="pricing">
                            <h3 class="text-center text-black">{{$service->title}}</h3>
                            <div class="price text-center mb-4 ">
                                <span><span>{{$service->pricing}}</span> / month</span>
                            </div>
                            ...
                            <p class="text-center">
                                <a href="{{route('register')}}" class="btn btn-primary">Subscribe Now</a>
                            </p>
                        </div>
                    </div>
                @endforeach
