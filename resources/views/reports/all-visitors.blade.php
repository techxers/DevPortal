            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Visitor reports for {{\App\Organisation::all()->count()-1}}
                            Organisations</h3>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="cs-hidden">
                                                <input type="text" name="report_id" class="form-control mr-2"
                                                       value="{{\Illuminate\Support\Facades\Crypt::encrypt(1003)}}">
                                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table data-list-view dataex-html5-selectors">
                                ...
                                @foreach($organisation_visitors as $visit)
                                    ...
                                    @if($visit->organisation_id==1)
                                        @continue;
                                    @endif
                                    <tr>
                                        <td title="{{$visit->id}}" class="small"><span class="test"></span></td>
                                        <td class="small">{{$count++}}</td>

                                        <td class="small">{{$visit->first_name." ".$visit->last_name}}</td>

                                        <td class="small">{{\App\Organisation::find($visit->organisation_id)->name}}</td>
