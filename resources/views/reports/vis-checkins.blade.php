            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Visitor reports for {{$organisation->name}}
                        </h3>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="cs-hidden">
                                                <input type="text" name="report_id" class="form-control mr-2"
                                                       value="{{\Illuminate\Support\Facades\Crypt::encrypt(1004)}}">
                                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table data-list-view dataex-html5-selectors">
                                ...
                                @foreach($organisation_visitors as $visit)
                                    @if($visit->visitor_state!=2 || $visit->organisation_id!=$organisation->id)
                                        @continue
                                    @endif
                                    <tr>
                                        ...
                                        <td class="small"  class="text-lowercase">{{$visit->email}}</td>
                                        ...
                                        <td class="small">{{date_format(date_create($visit->date_of_visit), 'g:i A')}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
