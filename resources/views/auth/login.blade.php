    ...
    <div class="login login-with-news-feed">
        ...
        <div class="right-content">
            ...
            <div class="login-header">
                ...
                <div class="icon">
                    <a href="{{route('register')}}" style="text-decoration: none;color:lightgrey"><i class="fa fa-sign-in"></i></a>
                </div>
            </div>
            <!-- end login-header -->
            <!-- begin login-content -->
                ...
                <form method="POST" action="{{ route('login') }}"
                    ...
                    <div class="m-t-20 text-inverse">
                        Forgot password? Click <a
                                href="{{ route('password.request') }}">here</a> to retrieve.
                    </div>
                    <div class="m-t-20 m-b-40 p-b-40 text-inverse">
                        Not yet registered? Click <a
                                href="{{ route('register') }}">here</a> to register.
                    </div>
                    <hr>
