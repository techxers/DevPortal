...
@section('title', 'Register/Appointment')

@section('vendor-style')
    <!-- vednor css files -->
    <link rel="stylesheet" href="{{ asset('vendors/css/animate/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('vendors/css/extensions/sweetalert2.min.css') }}">
    <link rel="stylesheet" href="{{ asset('custom/wickedpicker.min.css') }}">
...
@section('mystyle')
    ...
    <link rel="stylesheet" href="{{ asset('custom/wickedpicker.css') }}">
                                                            ...
                                                            <div class="table-responsive">
                                                                <div class="table-responsive text-right">
                                                                    <table
                                                                        ...
                                                                        @foreach(\App\Appointment::where("organisation_id",$organisation->id)->get() as $appoint)
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>{{date_format(date_create($appoint->dateTime),'l jS F Y')}}</td>
                                                                                <td>{{date_format(date_create($appoint->dateTime),'G:ia')}}</td>
                                                                                <td>{{$appoint->visitor->host}}</td>
                                                                                <td>{{$appoint->visitor->office}}</td>
                                                                                <td>{{$appoint->visitor->comments}}</td>
                                                                            </tr>
                                                                        @endforeach

                                                                        @if(\App\Appointment::where("organisation_id",$organisation->id)->get()->count()<1)
                                                                            <td>-</td>
...
@section('vendor-script')
    ...
    <script type="text/javascript" src="{{asset('custom/wickedpicker.min.js')}}"></script>
@endsection
@section('myscript')
    <!-- Page js files -->
    <script src="{{ asset('js/scripts/forms/wizard-steps3.js') }}"></script>
    ...
    {{--<script type="text/javascript" src="{{asset('custom/jquery-1.11.3.min.js')}}"></script>--}}
    <script type="text/javascript" src="{{asset('custom/wickedpicker.js')}}"></script>
