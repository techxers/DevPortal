<?php $__env->startSection('title', 'Check outs'); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Check out reports for <?php echo e($organisation->name); ?>
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            <p class="card-text">
                                Contains complete visitor walk in records organisations
                            </p>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="cs-hidden">
                                                <input type="text" name="report_id" class="form-control mr-2"
                                                       value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt(1005)); ?>">
                                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table data-list-view dataex-html5-selectors">
                                ...
                                <?php
                                    $count=1;
                                ?>
                                <?php $__currentLoopData = $organisation_visitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($visit->visitor_state!=3 || $visit->organisation_id !=$organisation->id): ?>
                                        <?php continue; ?>
                                    <?php endif; ?>
                                    <tr>
                                        <td class="small" title="<?php echo e($visit->id); ?>"></td>
                                        <td class="small" class="small"><?php echo e($count++); ?></td>
                                        <td class="small"><?php echo e($visit->first_name." ".$visit->last_name); ?></td>
                                        <td class="small text-lowercase"><?php echo e($visit->email); ?></td>
                                        ...
                                        <td class="small"><?php echo e(date_format(date_create($visit->date_of_visit), 'd/m/Y')); ?></td>
                                        <td class="small"><?php echo e(date_format(date_create($visit->time_in), 'g:i A')); ?></td>
                                        <td class="small"><?php echo e(date_format(date_create($visit->time_out), 'g:i A')); ?></td>
                                        <td class="small">
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\code\Neutron\resources\views/reports/vis-checkout.blade.php ENDPATH**/ ?>