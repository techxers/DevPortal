...
<!----><!---->        <meta name="locale" content="en_US">
    <meta id="config">
    <link rel="canonical" href="https://connectify.com/">
      
        <link rel="alternate" hreflang="x-default" href="https://www.connectify.com/">

<!---->
      <link rel="icon" src="img/brand/connectify.png">

      <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=--3hvgy7INJQ2JMv5Riyq9jXAINAtY1SfpYCpgAmpGTTJx98I8ZWBh2fOCwbhcMw" charset="UTF-8"></script><script>
...
<!---->
    ...
    <meta property="og:site_name" content="Connectify Kenya: Log In or Sign Up">
    <meta name="description" content="Find your next employer. Fast and easy.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta property="og:title" content="Connectify Kenya: Log In or Sign Up">
    <meta property="og:description" content="Find your next employer. Fast and easy.">
    <meta property="og:type" content="website">
    <meta name="litmsProfileName" content="homepage-guest-frontend">
    <meta property="og:url" content="https://connectify.com/">
    <meta name="naver-site-verification" content="6c180087cc8c9aef0b448521383709b955b7dc5b">
    <meta property="og:image" content="img/brand/connectify.png">

    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@linkedin">
    <meta name="twitter:title" content="LinkedIn Kenya: Log In or Sign Up">
    <meta name="twitter:description" content="Find your next employer. Fast and easy">
...
<link rel="stylesheet" href="https://static-exp1.licdn.com/sc/h/87w2ydgw477q2lrwjdo9d48zb">
...
<nav class="nav" aria-label="Main">
  <a href="/" class="nav__logo-link" data-tracking-control-name="guest_homepage-basic_nav-header-logo" data-tracking-will-navigate>
      <span class="nav__logo-text">Connectify</span>
      <img class="nav__logo"src="img/brand/connectify.png" alt="">
  </a>
...
<section class="dismissable-input typeahead-input location-typeahead-input">
  <input aria-label="Location" name="location" class="dismissable-input__input" value="Nairobi" placeholder="Location" autocomplete="off" data-tracking-control-name="guest_homepage-basic_dismissable-input" maxlength="500" type="search">
    <button class="dismissable-input__button" data-tracking-control-name="guest_homepage-basic_dismissable-input-clear" type="button">
      <label class="screen-reader-text">Dismiss</label>
      <li-icon class="dismissable-input__button-icon" data-delayed-url="https://static-exp1.licdn.com/sc/h/cs55jggk4p3uqh9ozxdmpvjg7"></li-icon>
    </button>
...
<!---->    </section>
            ...
            <a class="nav__button-tertiary" href="/" data-tracking-control-name="guest_homepage-basic_nav-header-join" data-tracking-will-navigate>Join now</a>
                      

    
    <a class="nav__button-secondary" href="/" data-tracking-control-name="guest_homepage-basic_nav-header-signin" data-tracking-will-navigate>Sign in</a>
...
<form class="sign-in-form" action="https://www.linkedin.com/uas/login-submit" method="post" novalidate>
  <input name="loginCsrfParam" value="4e99eea8-561c-4e9f-8605-bb9d1f98ff12" type="hidden">
...
<div class="hero">
  <h1 class="hero__headline hero__headline--basic mb-1">Connecting developers to companies </h1>
  <img class="hero__illustration--desktop" src="img/brand/dreamer.png" alt="Welcome to your professional community">
  <img class="hero__illustration--desktop" src="img/brand/dreamer.png" alt="Welcome to your professional community">
</div>
...
<section class="dismissable-input typeahead-input location-typeahead-input">
  <input aria-label="Location" name="location" class="dismissable-input__input" value="Nairobi, Nairobi, Kenya" placeholder="Location" autocomplete="off" data-tracking-control-name="homepage-basic_dismissable-input" maxlength="500" type="search">
    <button class="dismissable-input__button" data-tracking-control-name="homepage-basic_dismissable-input-clear" type="button">
      <label class="screen-reader-text">Dismiss</label>
      <li-icon class="dismissable-input__button-icon" data-delayed-url="https://static-exp1.licdn.com/sc/h/cs55jggk4p3uqh9ozxdmpvjg7"></li-icon>
    </button>
  ...
  <div class="typeahead-input__dropdown">
    ...
    <button class="base-search-bar__submit-btn" aria-label="Search" data-tracking-control-name="homepage-basic_jobs-search-bar_base-search-bar-search-submit" type="submit">
      <li-icon class="base-search-bar__search-icon onload" data-delayed-url="/"></li-icon>
    </button>
  </form>
</section>
...
<div class="job-finder-cta">
  <h2 class="job-finder-cta__header">Update your experience and get connected.</h2>
...
<!---->
  ...
  <a href="/" data-tracking-control-name="homepage-basic_suggested-search" data-tracking-will-navigate class="pill">
...
<div class="talent-finder-cta" data-impression-id="homepage-basic_talent-finder-cta">
  <h2 class="talent-finder-cta__header">Fast and easy way to source for talent</h2>
  

  <a href="/" data-tracking-control-name="homepage-basic_talent-finder-cta" data-tracking-will-navigate class="pill pill--talent-finder-cta">
...
<div class="brand-discovery" data-impression-id="homepage-basic_brand-discovery">
  <div class="brand-discovery__cta">
    <h2 class="brand-discovery__header">Who is Connectify for?</h2>
    <h3 class="brand-discovery__subtitle">Companies or developers. We simplify your talent sourcing</h3>
    <ul>
      <li>
        <a class="brand-discovery__button" data-tracking-control-name="homepage-basic_brand-discovery" data-tracking-will-navigate href="/">
          Create profile
...
<div class="join-cta lazy-load" data-impression-id="guest_homepage-basic_join-cta">
  <h2 class="join-cta__header">Get the exposure that you deserve</h2>
  

  <a href="/" data-tracking-control-name="guest_homepage-basic_join-cta" data-tracking-will-navigate class="pill pill--blue pill--join-cta">
...
<div class="directory" style="justify-content: center;" data-impression-id="homepage-basic_directory">
  <img  class="directory__logo" src="/img/brand/connectify.png" alt="">
  <div class="directory__lists">
      <div class="directory__column">
        <p class="directory__list-item directory__list-item--heading">
          General
        </p>
        <ul class="directory__list">
            <li class="directory__list-item">
              <a class="directory__link" href="/" data-tracking-control-name="guest_homepage-basic_directory" data-tracking-will-navigate>
                Sign Up
              </a>
            </li>
            <li class="directory__list-item">
              <a class="directory__link" href="/" data-tracking-control-name="homepage-basic_directory_helpCenterUrl" data-tracking-will-navigate>
                Help Center
              </a>
            </li>
            <li class="directory__list-item">
              <a class="directory__link" href="/" data-tracking-control-name="homepage-basic_directory_aboutUrl" data-tracking-will-navigate>
                About
              </a>
            </li>
            <li class="directory__list-item">
              <a class="directory__link" href="/" data-tracking-control-name="homepage-basic_directory_pressMicrositeUrl" data-tracking-will-navigate>
                Press
              </a>
            </li>
            <li class="directory__list-item">
              <a class="directory__link" href="/" data-tracking-control-name="homepage-basic_directory_blogMicrositeUrl" data-tracking-will-navigate>
                Blog
              </a>
            </li>
            <li class="directory__list-item">
              <a class="directory__link" href="/
              " data-tracking-control-name="homepage-basic_directory_careersUrl" data-tracking-will-navigate>
                Careers
              </a>
            </li>
        </ul>
...
<footer class="li-footer ">
  <ul class="li-footer__list">
    <li class="li-footer__item">
      <span class="sr-only">Connectify</span>
      <img class="li-footer__copy-logo" src="img/brand/connectify.png">
      <span class="li-footer__copy-text">&copy; 2020</span>
    </li>
    <li class="li-footer__item">
      <a href="/" data-tracking-control-name="homepage-basic_footer-about" data-tracking-will-navigate class="li-footer__item-link">
        About
      </a>
    </li>
    <li class="li-footer__item">
      <a href="/" data-tracking-control-name="homepage-basic_footer-user-agreement" data-tracking-will-navigate class="li-footer__item-link">
        User Agreement
      </a>
    </li>
    <li class="li-footer__item">
      <a href="/" data-tracking-control-name="homepage-basic_footer-privacy-policy" data-tracking-will-navigate class="li-footer__item-link">
        Privacy Policy
      </a>
    </li>
    <li class="li-footer__item">
...
<?php /**PATH C:\Techxers\Neutron - Copy\resources\views/landing/index.blade.php ENDPATH**/ ?>