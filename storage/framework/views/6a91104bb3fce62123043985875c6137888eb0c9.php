<?php $__env->startSection('title', 'Users Reports'); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Users reports for <?php echo e(\App\Organisation::all()->count()); ?>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="cs-hidden">
                                                <input type="text" name="report_id" class="form-control mr-2"
                                                       value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt(1002)); ?>">
                                            </div>
                    ...
                    <section id="data-list-view" class="data-list-view-header">
                        ...
                        <div class="table-responsive">
                            <table class="table data-list-view dataex-html5-selectors">
                                ...
                                <?php $__currentLoopData = $organisation_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $org_user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="small" title="<?php echo e($org_user->id); ?>"></td>
                                        <td class="small"><?php echo e($count++); ?></td>
                                        <td class="small"><?php echo e($org_user->name); ?></td>
                                        <td class="small" colspan="2">
                                            <?php echo e($org_user->phone); ?>

                                            <?php echo e($org_user->email); ?>

                                        </td>
                                        <td class="small"><?php echo e($org_user->organisation->name); ?>

                                        </td>
                                        <td class="small">
                                            <?php if($org_user->role_id==1): ?>
                                                SuperAdmin
                                            <?php elseif($org_user->role_id==2): ?>
                                                Admin
                                            <?php elseif($org_user->role_id==3): ?>
                                                Reception

                                            <?php elseif($org_user->role_id==4): ?>
                                                Security
                                            <?php endif; ?>
                                        </td>
                                        <td class="small">
                                            <?php if($org_user->email_verified_at!=null): ?>
                                                Yes
                                            <?php else: ?>
                                                No
                                            <?php endif; ?>
                                        </td>
                                        <td class="small"><?php echo e(date_format(date_create($org_user->created_at), 'd-M-Y H:i:a')); ?></td>
                                    </tr>
...
<?php $__env->startSection('myscript'); ?>
    ...
    <script>
        ...
        $('.action-sms').on("click", function (e) {
            e.stopPropagation();
            SendMultiMessages("user(s)", "<?php echo e(route("message-user")); ?>", false)
        });

        //Initialise send emails
        $('.action-mail').on("click", function (e) {
            e.stopPropagation();
            SendMultiEmails("user(s)", "<?php echo e(route("email-user")); ?>", false)
        })
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\code\Neutron\resources\views/reports/all-users.blade.php ENDPATH**/ ?>