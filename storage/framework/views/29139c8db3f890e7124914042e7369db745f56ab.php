<?php $__env->startSection('title', 'Visitor Reports'); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Visitor reports for <?php echo e($organisation->name); ?>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="cs-hidden">
                                                <input type="text" name="report_id" class="form-control mr-2"
                                                       value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt(1004)); ?>">
                                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table data-list-view dataex-html5-selectors">
                                ...
                                <?php $__currentLoopData = $organisation_visitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($visit->visitor_state!=2 || $visit->organisation_id!=$organisation->id): ?>
                                        <?php continue; ?>
                                    <?php endif; ?>
                                    <tr>
                                        ...
                                        <td class="small"  class="text-lowercase"><?php echo e($visit->email); ?></td>
                                        ...
                                        <td class="small"><?php echo e(date_format(date_create($visit->date_of_visit), 'g:i A')); ?></td>
                                    </tr>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\code\Neutron\resources\views/reports/vis-checkins.blade.php ENDPATH**/ ?>