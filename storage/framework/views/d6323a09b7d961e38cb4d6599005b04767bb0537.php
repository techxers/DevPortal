                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('add-visitor')); ?>" name="visRegisterForm"
                                  class="steps-validationd wizard-circle">
                                <?php echo csrf_field(); ?>
                                ...
                                <fieldset style="padding: 64px 4px;">
                                    ...
                                    <div class="pt-2 pb-3 text-center justify-content-center" id="notExpected">
                                        <div class="form-group text-center">
                                            ...
                                            <input type="text" name="assetsHolder" id="assetsHolder"
                                                   class="cs-hidden">
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\code\Neutron\resources\views/portal/create-appointments.blade.php ENDPATH**/ ?>