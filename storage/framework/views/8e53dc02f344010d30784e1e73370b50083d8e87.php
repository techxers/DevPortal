                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <hr class="my-4"/>
                            <p>Your profile can only be viewed with the system admins, its important
                            to update your profile for easier communication between the system  users.</p>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" id="date" name="date"
                                                   class="form-control form-control-alternative"
                                                   placeholder="Your registered" value="<?php echo e($user->created_at); ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Techxers\Neutron\resources\views/portal/profile-user.blade.php ENDPATH**/ ?>