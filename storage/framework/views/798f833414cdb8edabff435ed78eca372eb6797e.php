                ...
                <form action="<?php echo e(route('org-profile-update')); ?>"
                   ...
                   <div class="card bg-secondary shadow mt-2">
                       ...
                       <div class="rounded card-body"
                           ...
                           <h3 class="text-muted mb-4 cs-text-shadow">Organisation Basic</h3>
                           <div class="pl-lg-4">
                               <div class="row">
                                   <div class="col-lg-6">
                                       <div class="form-group">
                                           <label class="form-control-label cs-text-shadow text-white"
                                                  for="name">Name</label>
                               ...
                               <div class="row">
                                   <div class="col-lg-6">
                                       <div class="form-group">
                                           <label class="form-control-label text-black cs-text-shadow text-white cs-text-shadow"
                                   ...
                                   <div class="col-lg-6">
                                       <div class="form-group">
                                           <label class="form-control-label text-white cs-text-shadow"
                       ...
                       <div class="rounded card-body"
                           ...
                           <div class="pl-lg-4">
                               <div class="row">
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           <label class="form-control-label cs-text-shadow text-white" for="postcode">Postal
                                               Address</label>
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-lg-4">
                                       <div class="form-group">
                                           <label class="form-control-label cs-text-shadow text-white" for="country">Country</label>
                   ...
                   <button style="background-image: linear-gradient(to top, #48c6ef 0%, #6f86d6 100%);color: white" type="submit"
                           class="btn-block pt-2 pb-2 cs-text-shadow">Update company profile
                   </button>
               </form>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Techxers\Neutron\resources\views/portal/profile-organisation.blade.php ENDPATH**/ ?>