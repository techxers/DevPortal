            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Visitor reports for <?php echo e(\App\Organisation::all()->count()-1); ?>
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            <p class="card-text">
                                Contains complete visitor record for all organisations
                            </p>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="cs-hidden">
                                                <input type="text" name="report_id" class="form-control mr-2"
                                                       value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt(1003)); ?>">
                                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table data-list-view dataex-html5-selectors">
                                ...
                                <?php $__currentLoopData = $organisation_visitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($visit->organisation_id==1): ?>
                                        <?php continue; ?>;
                                    <?php endif; ?>
                                    <tr>
                                        <td title="<?php echo e($visit->id); ?>" class="small"><span class="test"></span></td>
                                        <td class="small"><?php echo e($count++); ?></td>

                                        <td class="small"><?php echo e($visit->first_name." ".$visit->last_name); ?></td>

                                        <td class="small"><?php echo e(\App\Organisation::find($visit->organisation_id)->name); ?></td>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\code\Neutron\resources\views/reports/all-visitors.blade.php ENDPATH**/ ?>