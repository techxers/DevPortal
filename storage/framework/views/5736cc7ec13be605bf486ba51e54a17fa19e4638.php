    ...
    <section id="dashboard-ecommerce" class="">
        ...
        <div class="row mt-8">
            <div class="col-lg-8 col-md-6 col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-end">
                        <h3 class="mb-0 text-center text-blue cs-text-shadow-white" style="font-size: 20px">VMS Subscription</h3>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-end">
                        <h3 class="mb-0 text-center text-blue cs-text-shadow-white" style="font-size: 20px">System Usage</h3>
               ...
               <div class="col">
                   <div class="card shadow">
                       <div class="card-header border-0">
                           <h3 class="mb-0 cs-text-shadow-white pb-3" style="font-size: 24px;color: #4285f4">Organisations Summary</h3>
                       </div>
                                           ...
                                           <div class="media align-items-center">
                                               <a href="#" class="avatar rounded-circle mr-3">
                                                   <img alt="Image placeholder"
                                                        src="/storage/<?php echo e($ogt->image??'organisation/logo/org_default.svg'); ?>">
                                               </a>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Techxers\Neutron\resources\views/portal/summary1.blade.php ENDPATH**/ ?>