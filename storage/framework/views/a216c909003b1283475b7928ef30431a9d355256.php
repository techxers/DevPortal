                ...
                <nav class="site-navigation position-relative text-right" role="navigation">
                    ...
                    <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                        ...
                        <li class="has-children">
                            ...
                            <ul class="dropdown">
                                <li><a href="#pricing-section" class="nav-link">Register(Lease)</a></li>
...
</header><?php /**PATH C:\Techxers\Neutron\resources\views/layouts/navbar-landing.blade.php ENDPATH**/ ?>