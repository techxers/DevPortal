...
<?php $__env->startSection('vendor-style'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('at/vendors/css/file-uploaders/dropzone.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('at/vendors/css/tables/datatable/extensions/dataTables.checkboxes.css')); ?>">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mystyle'); ?>
    
    <link rel="stylesheet" href="<?php echo e(asset('at/css/plugins/file-uploaders/dropzone.css')); ?>">
    ...
    <section id="data-list-view" class="data-list-view-header">
        ...
        <div class="table-responsive">
            <table class="table data-list-view">
                <thead>
                <tr>
                    <th class="text-uppercase">Manage</th>
                    <th>Organisation</th>
                ...
                <?php $__currentLoopData = $organisations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ogt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                            ...
                            <div class="media align-items-center">
                                <a href="#" class="avatar rounded-circle mr-3">
                                    <img alt="Image placeholder"
                                         src="http://127.0.0.1:8000/storage/<?php echo e($ogt->image??'organisation/logo/org_default.svg'); ?>">
                                </a>
                        ...
                        <td>
                            <?php echo e(array("Basic","Enterprise","Corporate")[random_int(0,2)]); ?>
                                ...
                                <?php $__currentLoopData = $ogt->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orgUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <a href="#" class="avatar avatar-sm" data-toggle="tooltip"
                                       data-original-title="<?php echo e($orgUser->name); ?>">
                                        <img src="http://127.0.0.1:8000/storage/<?php echo e($orgUser->image??'user/profiles/user_default.svg'); ?>"
...
<?php endif; ?>
    ...
    <div class="showModal" id="showModal" >
        <div style="position: absolute;left: 0;right: 0;top: 0;bottom: 0;" onclick="document.getElementById('showModal').style.display='none'"></div>
...
<?php $__env->startSection('vendor-script'); ?>
    ...
    <script src="<?php echo e(asset('at/vendors/js/extensions/dropzone.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('at/vendors/js/tables/datatable/datatables.checkboxes.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('myscript'); ?>
    
    <script src="<?php echo e(asset('at/js/scripts/ui/data-list-view.js')); ?>"></script>
    <script src="<?php echo e(asset('at/js/scripts/popover/popover.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Techxers\Neutron\resources\views/portal/organisations.blade.php ENDPATH**/ ?>